  ...
  return (
      <div>
        ...
        <section id="about" className="bg-white p-6 rounded-lg shadow-md my-8 max-w-4xl">
          ...
          <p className="text-lg mb-6">A website for various sports to track game results. Users can create spaces, each containing multiple sports and teams, and track the results of players and teams within each space.</p>
